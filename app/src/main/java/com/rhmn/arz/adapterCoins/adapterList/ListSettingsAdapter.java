...
public class ListSettingsAdapter extends RecyclerView.Adapter<ListSettingsAdapter.MyView> {
    ...
    public
    String[] labels = {
            "ویرایش پروفایل", "تنظیمات",  "درباره ما", "ddd", ";;"
    ...
    public ListSettingsAdapter(ArrayList<String> pl){
    }

    @NonNull
    @Override
    public ListSettingsAdapter.MyView onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        context = parent.getContext();
        View itemview = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_view_row_2, parent, false);
        return new ListSettingsAdapter.MyView(itemview);
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull ListSettingsAdapter.MyView holder, int position) {
